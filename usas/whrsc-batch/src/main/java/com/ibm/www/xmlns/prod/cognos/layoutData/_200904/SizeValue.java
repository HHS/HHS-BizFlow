...
public class SizeValue  implements java.io.Serializable {
    ...
    /* Type of unit */
    private com.ibm.www.xmlns.prod.cognos.layoutData._200904.SizeUnitEnum units;
    ...
    public SizeValue(
           double val,
           com.ibm.www.xmlns.prod.cognos.layoutData._200904.SizeUnitEnum units,
     ...
     */
    public com.ibm.www.xmlns.prod.cognos.layoutData._200904.SizeUnitEnum getUnits() {
        return units;
    }
     ...
     */
    public void setUnits(com.ibm.www.xmlns.prod.cognos.layoutData._200904.SizeUnitEnum units) {
        this.units = units;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ibm.com/xmlns/prod/cognos/layoutData/200904", "SizeValue"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.ibm.com/xmlns/prod/cognos/layoutData/200904", "units"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.ibm.com/xmlns/prod/cognos/layoutData/200904", "SizeUnitEnum"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
