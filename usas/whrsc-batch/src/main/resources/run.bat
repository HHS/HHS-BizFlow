...
set EXECJAR=%BASEDIR%\usaswhrsc-0.0.1-SNAPSHOT.jar

::-----------------------------
:: Build the CLASSPATH required
::-----------------------------
set CLASSPATH=%CLASSPATH%;.;%BASEDIR%;%LIB_DIR%\*;%CONF_DIR%
...
"%JAVA_HOME%\bin\java" -classpath %CLASSPATH% gov.hhs.usas.dss.USASInterfaceApplication  %1 %2 %3 %4 %5
