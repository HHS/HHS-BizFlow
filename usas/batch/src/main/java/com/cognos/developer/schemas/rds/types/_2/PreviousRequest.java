...
public class PreviousRequest  implements java.io.Serializable {
    ...
    /**
     * Gets the session value for this PreviousRequest.
     * 
     * @return session
     */
    ...
    /**
     * Sets the session value for this PreviousRequest.
     * 
     * @param session
     */
    ...
    /**
     * Gets the extension value for this PreviousRequest.
     * 
     * @return extension
     */
    ...
    /**
     * Sets the extension value for this PreviousRequest.
     * 
     * @param extension
     */
	...
	public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PreviousRequest)) return false;
        PreviousRequest other = (PreviousRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PreviousRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://developer.cognos.com/schemas/rds/types/2", ">PreviousRequest"));
