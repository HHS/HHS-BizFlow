...
public class ReleaseRequest  implements java.io.Serializable {
    ...
    /**
     * Gets the session value for this ReleaseRequest.
     * 
     * @return session
     */
    ...
    /**
     * Sets the session value for this ReleaseRequest.
     * 
     * @param session
     */
    ...
    /**
     * Gets the extension value for this ReleaseRequest.
     * 
     * @return extension
     */
    ...
    /**
     * Sets the extension value for this ReleaseRequest.
     * 
     * @param extension
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://developer.cognos.com/schemas/rds/types/2", ">ReleaseRequest"));
