...
public class StatusEnum implements java.io.Serializable {
    ...
    public static final StatusEnum working = new StatusEnum(_working);
    public static final StatusEnum complete = new StatusEnum(_complete);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://developer.cognos.com/schemas/raas/Returns__by__Order__Method___x002d__Prompted__Chart", "StatusEnum"));
    }
    /**
