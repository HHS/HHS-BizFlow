...
import gov.hhs.batch.ehrp.model.ApprovalsTags;
import gov.hhs.batch.ehrp.model.Candidates;
import gov.hhs.batch.ehrp.model.CandidatesTags;
import gov.hhs.batch.ehrp.model.DepartmentHierarchy;
import gov.hhs.batch.ehrp.model.DepartmentHierarchyTags;
import gov.hhs.batch.ehrp.model.EmployeeReplacement;
import gov.hhs.batch.ehrp.model.EmployeeReplacementTags;
import gov.hhs.batch.ehrp.model.EwitsDetails;
import gov.hhs.batch.ehrp.model.EwitsDetailsTags;
import gov.hhs.batch.ehrp.model.JobCodeDetail;
import gov.hhs.batch.ehrp.model.JobCodeDetailTags;
import gov.hhs.batch.ehrp.model.JobCodeTags;
import gov.hhs.batch.ehrp.model.JobCodes;
import gov.hhs.batch.ehrp.model.Openings;
import gov.hhs.batch.ehrp.model.OpeningsTags;
import gov.hhs.batch.ehrp.model.PositionDeptHierarchy;
import gov.hhs.batch.ehrp.model.PositionDeptHierarchyTags;
import gov.hhs.batch.ehrp.model.PositionDetail;
import gov.hhs.batch.ehrp.model.PositionDetailTags;
import gov.hhs.batch.ehrp.model.Positions;
import gov.hhs.batch.ehrp.model.PositionsTags;
import gov.hhs.batch.ehrp.model.RequisitionDetail;
import gov.hhs.batch.ehrp.model.RequisitionDetailTags;
import gov.hhs.batch.ehrp.model.SalaryDetail;
import gov.hhs.batch.ehrp.model.SalaryDetailTags;
...
public class EHRPXMLObjectData {
	...
	@Autowired
	private EmployeeReplacementTags empReplTags;
	@Autowired
