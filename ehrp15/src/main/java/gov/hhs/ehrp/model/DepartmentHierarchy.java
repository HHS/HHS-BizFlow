...
public class DepartmentHierarchy {
	...
	public DepartmentHierarchy(String jobReqNbr, String setId, String deptId, String descr, String parLine2,
	...
	public String toString() {
		return "DepartmentHierarchy [jobReqNbr=" + jobReqNbr + ", setId=" + setId + ", deptId=" + deptId + ", descr="
