...
public class GetOutputRequest  implements java.io.Serializable {
    ...
    /**
     * Gets the session value for this GetOutputRequest.
     * 
     * @return session
     */
    ...
    /**
     * Sets the session value for this GetOutputRequest.
     * 
     * @param session
     */
    ...
    /**
     * Gets the extension value for this GetOutputRequest.
     * 
     * @return extension
     */
    ...
    /**
     * Sets the extension value for this GetOutputRequest.
     * 
     * @param extension
     */
	...
	public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetOutputRequest)) return false;
        GetOutputRequest other = (GetOutputRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetOutputRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://developer.cognos.com/schemas/rds/types/2", ">GetOutputRequest"));
