...
public class Task {
	...
	//Task Report Search Path
	private static String SEARCH_PATH = "/content/folder[@name='USA Staffing Packages and Folders']/package[@name='Staffing Reports']/folder[@name='Data Self Service']/report[@name='Task Data Self Service']";
	...
	private static String fileName = "TaskDSS";
