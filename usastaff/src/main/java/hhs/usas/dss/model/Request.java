...
public class Request {
	...
	//Request Report Search Path
	private static String SEARCH_PATH = "/content/folder[@name='USA Staffing Packages and Folders']/package[@name='Staffing Reports']/folder[@name='Data Self Service']/report[@name='Request Data Self Service']";
	...
	private static String fileName = "RequestDSS";
