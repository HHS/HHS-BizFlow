...
public class Certificate {
	...
	//Certificate Report Search Path
	private static String SEARCH_PATH = "/content/folder[@name='USA Staffing Packages and Folders']/package[@name='Staffing Reports']/folder[@name='Data Self Service']/report[@name='Certificate Data Self Service']";
	
	//Staffing Date Type Prompt
	private static String SVP_NAME ="parm_StaffingDateType";
	private static String SVP_USEVAL="CertificateLastUpdateDate";
	private static String SVP_DISPLAY="Certificate Last Update Date";
	...
	private static String fileName = "CertificateDSS";
