...
public class Announcement {
	...
	//Announcement Report Search Path
	private static String SEARCH_PATH = "/content/folder[@name='USA Staffing Packages and Folders']/package[@name='Staffing Reports']/folder[@name='Data Self Service']/report[@name='Announcement Data Self Service']";
	
	//Staffing Date Type Prompt
	private static String SVP_NAME ="parm_StaffingDateType";
	private static String SVP_USEVAL="Announcement Last Update";
	private static String SVP_DISPLAY="Announcement Last Update";
	...
	private static String fileName = "AnnouncementDSS";
