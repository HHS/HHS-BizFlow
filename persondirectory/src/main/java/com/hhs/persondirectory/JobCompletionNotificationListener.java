...
public class JobCompletionNotificationListener extends JobExecutionListenerSupport {
	...
	public void afterJob(JobExecution jobExecution) {
		...
		if(StagingToFinalTasklet.getSqlcode() != 0){
			parametersMap.put("SQL_CODE", StagingToFinalTasklet.getSqlcode());
		}
		
		if(StagingToFinalTasklet.getSqlerrm() != null){
			parametersMap.put("SQL_MSG", StagingToFinalTasklet.getSqlerrm());
		}
