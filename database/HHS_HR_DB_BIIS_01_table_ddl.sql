...
CREATE INDEX HHS_HR.EMPLOYEE_LOOKUP_IDX1 ON HHS_HR.EMPLOYEE_LOOKUP (EMPLID);
CREATE INDEX HHS_HR.EMPLOYEE_LOOKUP_IDX2 ON HHS_HR.EMPLOYEE_LOOKUP (OPDIV, UPPER(FULL_NAME), ORG_CD);
...
(
	...
	EEOC_OPDIV              VARCHAR2(30),
	ARCHIVE_IND             VARCHAR2(1)
);

CREATE INDEX HHS_HR.ADMINISTRATIVE_CODE_IDX1 ON HHS_HR.ADMINISTRATIVE_CODE (OPDIV, ADMIN_CODE, ADMIN_CODE_DESC);
