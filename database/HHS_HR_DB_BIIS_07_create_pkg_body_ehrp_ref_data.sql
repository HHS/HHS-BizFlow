...
--------------------------------------------------------
--CURSOR: CUR_PS_HE_EWIT_DEPT
--DESCRIPTION: Fetches records from the EHRP PS_HE_EWIT_DEPT_1 table 
--------------------------------------------------------
CURSOR CUR_PS_HE_EWIT_DEPT
IS
	SELECT
		...
		, GVT_PAR_LINE5
		, GVT_PAR_DESCR5
	FROM EHRP.PS_HE_EWIT_DEPT_1@BIIS_DBLINK;

	TYPE TYP_PS_HE_EWIT_DEPT IS TABLE OF CUR_PS_HE_EWIT_DEPT%ROWTYPE
		INDEX BY PLS_INTEGER;

	PS_HE_EWIT_DEPTS TYP_PS_HE_EWIT_DEPT;
...
--DESCRIPTION : Inserts new records into 
--PS_HE_EWIT_DEPT_1 table, from BIIS
----------------------------------------------------------
PROCEDURE INSERT_EHRP_PS_HE_EWIT_DEPT_1
AS
BEGIN
	EXECUTE IMMEDIATE 'TRUNCATE TABLE PS_HE_EWIT_DEPT_1';
	OPEN CUR_PS_HE_EWIT_DEPT;
	LOOP
		FETCH CUR_PS_HE_EWIT_DEPT
		BULK COLLECT INTO PS_HE_EWIT_DEPTS
		LIMIT GCV_LIMIT;
		
		FORALL i IN  PS_HE_EWIT_DEPTS.FIRST..PS_HE_EWIT_DEPTS.LAST SAVE EXCEPTIONS
			INSERT INTO PS_HE_EWIT_DEPT_1 VALUES PS_HE_EWIT_DEPTS(i);
		COMMIT;
			
		EXIT WHEN CUR_PS_HE_EWIT_DEPT%NOTFOUND;
	END LOOP;
	CLOSE CUR_PS_HE_EWIT_DEPT;
	--CATCH EXCEPTIONS
EXCEPTION
	WHEN OTHERS THEN
		SINGLE_LOGGER();
END INSERT_EHRP_PS_HE_EWIT_DEPT_1;
