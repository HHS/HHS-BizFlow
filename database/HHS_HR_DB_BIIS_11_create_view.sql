...
--EHRP_JOB_REQ_VW
-------------------
CREATE OR REPLACE VIEW EHRP_JOB_REQ_VW AS
...
--EHRP_LOCATION_VW
----------------
CREATE OR REPLACE VIEW EHRP_LOCATION_VW
AS
...
--EHRP_POSITION_VW
----------------
CREATE OR REPLACE VIEW EHRP_POSITION_VW
AS
SELECT HRS_JOB_OPENING_ID,
	POSITION_NBR,
	HRS_JO_PRM_PSN_FLG,
...
--EHRP_JO_RPL_VW
----------------------
CREATE OR REPLACE VIEW EHRP_JO_RPL_VW
AS
