...
----------------------------------------------
CREATE INDEX DSS_ANNOUNCEMENT_DETAIL_I1 ON DSS_ANNOUNCEMENT_DETAIL (ANNOUNCEMENT_NUMBER);
...
----------------------------------------------
CREATE INDEX DSS_ANNOUNCEMENT_APPT_TYPE_I1 ON DSS_ANNOUNCEMENT_APPT_TYPE (ANNOUNCEMENT_NUMBER);
...
----------------------------------------------
CREATE INDEX DSS_ANNOUNCEMENT_WORK_SCHED_I1 ON DSS_ANNOUNCEMENT_WORK_SCHED (ANNOUNCEMENT_NUMBER);
...
----------------------------------------------
CREATE INDEX DSS_ANNOUNCEMENT_LOCATION_I1 ON DSS_ANNOUNCEMENT_LOCATION (ANNOUNCEMENT_NUMBER);
...
----------------------------------------------
CREATE INDEX DSS_APPLICATION_DETAIL_I1 ON DSS_APPLICATION_DETAIL (APPLICATION_NUMBER);
...
----------------------------------------------
CREATE INDEX DSS_APPLICATION_DOCUMENT_I1 ON DSS_APPLICATION_DOCUMENT (APPLICATION_NUMBER);
...
----------------------------------------------
CREATE INDEX DSS_APPLICATION_ELIGIBILITY_I1 ON DSS_APPLICATION_ELIGIBILITY (APPLICATION_NUMBER);
...
----------------------------------------------
CREATE INDEX DSS_APPLICATION_LOCATION_I1 ON DSS_APPLICATION_LOCATION (APPLICATION_NUMBER);
...
----------------------------------------------
CREATE INDEX DSS_APPLICANT_PHONE_I1 ON DSS_APPLICANT_PHONE (APPLICATION_NUMBER);
...
----------------------------------------------
CREATE INDEX DSS_APPLICATION_RATING_I1 ON DSS_APPLICATION_RATING (APPLICATION_NUMBER);
...
----------------------------------------------
CREATE INDEX DSS_CERTIFICATE_I1 ON DSS_CERTIFICATE (CERTIFICATE_NUMBER);
...
----------------------------------------------
CREATE INDEX DSS_CERTIFICATE_APP_I1 ON DSS_CERTIFICATE_APP (APPLICATION_NUMBER);
...
----------------------------------------------
CREATE INDEX DSS_NEW_HIRE_I1 ON DSS_NEW_HIRE (NEW_HIRE_NUMBER);
...
----------------------------------------------
CREATE INDEX DSS_REQUEST_DETAIL_I1 ON DSS_REQUEST_DETAIL (REQUEST_NUMBER);
...
----------------------------------------------
CREATE INDEX DSS_REQUEST_APPT_TYPE_I1 ON DSS_REQUEST_APPT_TYPE (REQUEST_NUMBER);
...
----------------------------------------------
CREATE INDEX DSS_REQUEST_LOCATION_I1 ON DSS_REQUEST_LOCATION (REQUEST_NUMBER);
...
--DDL for index DSS_REQUEST_LOCATION_I1
----------------------------------------------
CREATE INDEX DSS_REQUEST_POSITION_I1 ON DSS_REQUEST_POSITION (REQUEST_NUMBER);
...
----------------------------------------------
CREATE INDEX DSS_REQUEST_SPECIALTY_I1 ON DSS_REQUEST_SPECIALTY (REQUEST_NUMBER);
...
----------------------------------------------
CREATE INDEX DSS_REQUEST_VACANCY_I1 ON DSS_REQUEST_VACANCY (REQUEST_NUMBER);
...
----------------------------------------------
CREATE INDEX DSS_REQUEST_WORK_SCHED_I1 ON DSS_REQUEST_WORK_SCHED (REQUEST_NUMBER);
...
----------------------------------------------
CREATE INDEX DSS_REVIEW_DETAIL_I1 ON DSS_REVIEW_DETAIL (REVIEW_NAME);
...
----------------------------------------------
CREATE INDEX DSS_TASK_DETAIL_I1 ON DSS_TASK_DETAIL (TASK_ID);
...
----------------------------------------------
CREATE INDEX DSS_VACANCY_DETAIL_I1 ON DSS_VACANCY_DETAIL (VACANCY_NUMBER);
...
----------------------------------------------
CREATE INDEX DSS_VACANCY_CUSTOMER_I1 ON DSS_VACANCY_CUSTOMER (VACANCY_NUMBER);
...
----------------------------------------------
CREATE INDEX DSS_VACANCY_ELIGIBILITY_I1 ON DSS_VACANCY_ELIGIBILITY (VACANCY_NUMBER);
...
----------------------------------------------
CREATE INDEX DSS_VACANCY_POSITION_I1 ON DSS_VACANCY_POSITION (VACANCY_NUMBER);
...
----------------------------------------------
CREATE INDEX DSS_VACANCY_SPECIALTY_I1 ON DSS_VACANCY_SPECIALTY (VACANCY_NUMBER);
...
----------------------------------------------
CREATE INDEX DSS_VACANCY_DOCUMENT_I1 ON DSS_VACANCY_DOCUMENT (VACANCY_NUMBER);
...
----------------------------------------------
CREATE INDEX DSS_VACANCY_REQUEST_I1 ON DSS_VACANCY_REQUEST (VACANCY_NUMBER);
