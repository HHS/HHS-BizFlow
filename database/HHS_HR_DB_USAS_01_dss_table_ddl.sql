...
DROP TABLE HHS_HR.DSS_TIME_TO_RECRUIT;
...
------------------------------------
CREATE TABLE HHS_HR.DSS_TIME_TO_RECRUIT
(
    STAFFING_ORGANIZATION           VARCHAR2(122),
    REQUEST_NUMBER                  VARCHAR2(202),
...
----------------------------------------------
CREATE INDEX HHS_HR.DSS_TIME_TO_RECRUIT_I1 ON DSS_TIME_TO_RECRUIT (REQUEST_NUMBER);
