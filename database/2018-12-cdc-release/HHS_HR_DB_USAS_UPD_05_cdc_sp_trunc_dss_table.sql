...
--STORED PROCEDURE: SP_TRUNC_CDC_JR_TABLE
CREATE OR REPLACE PROCEDURE HHS_HR.SP_TRUNC_CDC_JR_TABLE
AS
BEGIN
--DESCRIPTION: Truncates the CDC JR Relationship Report Table
	EXECUTE IMMEDIATE 'TRUNCATE TABLE HHS_HR.DSS_CDC_JR_RLTNSHP_STG';
EXCEPTION
	WHEN OTHERS THEN
		SP_ERROR_LOG();
END;
