...
BEGIN
	BEGIN
		...
		SELECT COUNT(*)
		INTO V_FNL_CNT
		FROM HHS_HR.DSS_TIME_TO_STAFF;
		
		IF V_STG_CNT >= V_FNL_CNT THEN
...
IS
	...
	V_ANN_FNL_CNT               NUMBER;
	V_LOC_STG_CNT               NUMBER;
	V_LOC_FNL_CNT               NUMBER;
	V_RVW_STG_CNT               NUMBER;
	V_RVW_FNL_CNT               NUMBER;
	V_CERT_STG_CNT              NUMBER;
	V_CERT_FNL_CNT              NUMBER;
	V_HIRE_STG_CNT              NUMBER;
	V_HIRE_FNL_CNT              NUMBER;
	V_ERRCODE                   NUMBER(10);
	V_ERRMSG                    VARCHAR2(512);
	CURSOR CUR_ANN_STG
	IS
...
BEGIN
	BEGIN
		...
		SELECT COUNT(*)
		INTO V_ANN_FNL_CNT
		FROM HHS_HR.DSS_IHS_VAC_ANNOUNCEMENT;
		
		IF V_ANN_STG_CNT >= V_ANN_FNL_CNT THEN
	...
	BEGIN
		...
		SELECT COUNT(*)
		INTO V_LOC_FNL_CNT
		FROM HHS_HR.DSS_IHS_VAC_ANN_LOCATION;
		
		IF V_LOC_STG_CNT >= V_LOC_FNL_CNT THEN
	...
	BEGIN
		...
		SELECT COUNT(*)
		INTO V_RVW_FNL_CNT
		FROM HHS_HR.DSS_IHS_VAC_ANN_REVIEW;
		
		IF V_RVW_STG_CNT >= V_RVW_FNL_CNT THEN
	...
	BEGIN
		...
		SELECT COUNT(*)
		INTO V_CERT_FNL_CNT
		FROM HHS_HR.DSS_IHS_VAC_CERTIFICATE;
		
		IF V_CERT_STG_CNT >= V_CERT_FNL_CNT THEN
	...
	BEGIN
		...
		SELECT COUNT(*)
		INTO V_HIRE_FNL_CNT
		FROM HHS_HR.DSS_IHS_VAC_NEW_HIRE;
		
		IF V_HIRE_STG_CNT >= V_HIRE_FNL_CNT THEN
