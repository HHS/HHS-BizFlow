...
--TODO: finalize the match condition
		...
		--------------------------------
		-- DSS_IHS_VAC_REVIEW table
		--------------------------------
		--DBMS_OUTPUT.PUT_LINE('    DSS_IHS_VAC_REVIEW table');
		MERGE INTO DSS_IHS_VAC_REVIEW TRG
		USING
		(
			SELECT
				REQUEST_NUMBER
			...
			FROM INTG_DATA_DTL IDX
				, XMLTABLE(XMLNAMESPACES(DEFAULT 'http://www.ibm.com/xmlns/prod/cognos/dataSet/201006'), '/dataSet/dataTable/row[../id/text() = "lst_ReviewInfo"]'
					PASSING IDX.FIELD_DATA
					COLUMNS
						REQUEST_NUMBER                    VARCHAR2(202)    PATH 'Request__Number'
						, VIN                             NUMBER(10)       PATH 'Vacancy__Identification__Number'
