...
BEGIN
	...
	BEGIN
		...
		INSERT INTO DSS_TIME_TO_RECRUIT
			(STAFFING_ORGANIZATION
			, REQUEST_NUMBER
			, REQUEST_CREATE_DATE
	...
	EXCEPTION
		WHEN OTHERS THEN
			RAISE_APPLICATION_ERROR(-20961, 'SP_UPDATE_TIME2RECRUIT_TABLE: Invalid TIME TO RECRUIT data.  IA_ID = ' || TO_CHAR(I_ID) );
	END;
