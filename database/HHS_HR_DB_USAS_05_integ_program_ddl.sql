...
BEGIN
	...
	BEGIN
		--------------------------------
		-- DSS_TIME_TO_STAFF_STG table
		--------------------------------
		--DBMS_OUTPUT.PUT_LINE('    DSS_TIME_TO_STAFF_STG table');
		INSERT INTO DSS_TIME_TO_STAFF_STG
			(STAFFING_ORGANIZATION
			, REQUEST_NUMBER
			, REQUEST_CREATE_DATE
...
BEGIN
	...
	BEGIN
		--------------------------------
		-- DSS_TIME_TO_OFFER_STG table
		--------------------------------
		--DBMS_OUTPUT.PUT_LINE('    DSS_TIME_TO_OFFER_STG table');
		INSERT INTO DSS_TIME_TO_OFFER_STG
			(STAFFING_ORGANIZATION
			, REQUEST_NUMBER
			, PD_NUMBER
...
BEGIN
	...
	BEGIN
		--------------------------------
		-- DSS_IHS_VAC_ANNOUNCEMENT_STG table
		--------------------------------
		--DBMS_OUTPUT.PUT_LINE('    DSS_IHS_VAC_ANNOUNCEMENT_STG table');
		INSERT INTO DSS_IHS_VAC_ANNOUNCEMENT_STG
			(REQUEST_NUMBER
			, VIN
			, REQUEST_CREATE_DATE
			, REQUEST_STATUS
		...
		--------------------------------
		-- DSS_IHS_VAC_ANN_LOCATION_STG table
		--------------------------------
		--DBMS_OUTPUT.PUT_LINE('    DSS_IHS_VAC_ANN_LOCATION_STG table');
		INSERT INTO DSS_IHS_VAC_ANN_LOCATION_STG
			(REQUEST_NUMBER
			, VIN
			, ANNOUNCEMENT_NUMBER
			, LOCATION)
		...
		--------------------------------
		-- DSS_IHS_VAC_ANN_REVIEW_STG table
		--------------------------------
		--DBMS_OUTPUT.PUT_LINE('    DSS_IHS_VAC_ANN_REVIEW_STG table');
		INSERT INTO DSS_IHS_VAC_ANN_REVIEW_STG
			(REQUEST_NUMBER
			, VIN
			, ANNOUNCEMENT_NUMBER
			, REVIEW_STATUS
		...
		WHERE IDX.ID = I_ID;
				...
				--------------------------------
		-- DSS_IHS_VAC_CERTIFICATE_STG table
		--------------------------------
		--DBMS_OUTPUT.PUT_LINE('    DSS_IHS_VAC_CERTIFICATE_STG table');
		INSERT INTO DSS_IHS_VAC_CERTIFICATE_STG
			(REQUEST_NUMBER
			, VIN
			, REQUEST_STATUS
			, CERTIFICATE_NUMBER
		...
		WHERE IDX.ID = I_ID;
				...
				--------------------------------
		-- DSS_IHS_VAC_NEW_HIRE_STG table
		--------------------------------
		--DBMS_OUTPUT.PUT_LINE('    DSS_IHS_VAC_NEW_HIRE_STG table');
		INSERT INTO DSS_IHS_VAC_NEW_HIRE_STG
			(REQUEST_NUMBER
			, NEW_HIRE_NUMBER
			, NEW_HIRE_STATUS
			, NEW_HIRE_NAME
