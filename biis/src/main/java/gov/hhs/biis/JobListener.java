...
public class JobListener extends JobExecutionListenerSupport {
	...
	public void afterJob(JobExecution jobExecution) {
		...
		if(EmployeeTasklet.getSqlcode() != 0){
			parametersMap.put("SQL_CODE", EmployeeTasklet.getSqlcode());
		}
		
		if((EmployeeTasklet.getSqlerrm() != null) || (BIISRefDataTasklet.getSqlmsg() != null)|| (EHRPRefDataTasklet.getSqlmsg() != null)){
			parametersMap.put("SQL_MSG", BIISRefDataTasklet.getSqlmsg() + " " +EmployeeTasklet.getSqlerrm() + " " +EHRPRefDataTasklet.getSqlmsg());
		}
